...
const ManageJobs = () => {
    ...
    const fetchCompanyJobs = async () => {
        try {
            ...
            if (data.success) {
                ...
                // console.log("jobsData in the ManageJobs is : ", data.jobsData);
            } else {
    ...
    const changeJobVisibility = async (id) => {
        ...
        try {
            ...
            // console.log("Inside the changeJobVisibility function : ", data);
            if (data.success) {
                toast.success(data.message);
                fetchCompanyJobs()
            } else {
                toast.error(data.message);
                // console.log("Inside the error handler : ", data.message);
            }
        } catch (error) {
            toast.error(error.message);
        }
